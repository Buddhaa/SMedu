...
<body id="top">
<!-- top -->
<div class="wrapper row0"  data-spy="affix" data-offset-top="0">
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_right">
      <ul>
        <li><a href="#"><i class="fa fa-lg fa-home"></i>홈으로</a></li>
        <li><a href="#">로그인</a></li>
        <li><a href="#">회원가입</a></li>
...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    <h1><a href="index.html">SICKERMAN'S</a></h1>
...
<div class="wrapper row4">
  <nav id="mainav" class="hoc clear"> 
    <ul class="clear">
      <li><a class="drop" href="#">교육원소개</a>
      	<ul>
          <li><a href="#">프로젝트소개</a></li>
          <li><a href="#">교육원 소개 페이지</a></li>
